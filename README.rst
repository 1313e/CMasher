...
These Python modules can be placed in a local working directory, and can then be imported with ``from <cmap_name> import cmap`` (e.g., ``from rainforest import cmap`` to import the *rainforest* colormap).
